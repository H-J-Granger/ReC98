...
aMAX_COMBO              db 'Combo mÃximo            ~',0
aGAUGE_ATTACK_TIMES     db 'Ataque de carga         ~',0
aBOSS_ATTACK_TIMES      db 'Ataque de jefe          ~',0
aBOSS_REVERSAL_TIMES    db 'RevÅs de Jefe           ~',0
aBOSS_PANIC_TIMES       db 'Jefe de pÃnico          ~',0
aTOTAL                  db 'Total                     ',0
aWINNER_BONUS           db '         Bono de ganador        ',0
aALL_CLEAR              db '         ÐÐCOMPLETADO!!         ',0
aPLAYER_REM             db 'Jugadores restantes     ~',0
	evendata
